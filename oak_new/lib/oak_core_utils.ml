...
let struct_ty_of_iterated_binders_with
      context_size
      (field_specs : Syntax.term_field_spec list)
...
let struct_ty_of_iterated_binders =
  struct_ty_of_iterated_binders_with Evaluate.temporary_context_size
;;
